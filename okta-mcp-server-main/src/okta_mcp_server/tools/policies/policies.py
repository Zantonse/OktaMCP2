...
@mcp.tool()
async def create_policy(ctx: Context, policy_data: Dict[str, Any]) -> dict:
    """Create a new policy.
...
@mcp.tool()
async def update_policy(ctx: Context, policy_id: str, policy_data: Dict[str, Any]) -> dict:
...
@mcp.tool()
async def delete_policy(ctx: Context, policy_id: str) -> dict:
    """Delete a policy.
...
@mcp.tool()
async def activate_policy(ctx: Context, policy_id: str) -> dict:
    """Activate a policy.
...
@mcp.tool()
async def deactivate_policy(ctx: Context, policy_id: str) -> dict:
    """Deactivate a policy.
...
@mcp.tool()
async def list_policy_rules(ctx: Context, policy_id: str) -> dict:
...
@mcp.tool()
async def get_policy_rule(ctx: Context, policy_id: str, rule_id: str) -> dict:
...
@mcp.tool()
async def create_policy_rule(ctx: Context, policy_id: str, rule_data: Dict[str, Any]) -> dict:
...
@mcp.tool()
async def delete_policy_rule(ctx: Context, policy_id: str, rule_id: str) -> dict:
...
@mcp.tool()
async def activate_policy_rule(ctx: Context, policy_id: str, rule_id: str) -> dict:
...
@mcp.tool()
async def deactivate_policy_rule(ctx: Context, policy_id: str, rule_id: str) -> dict:

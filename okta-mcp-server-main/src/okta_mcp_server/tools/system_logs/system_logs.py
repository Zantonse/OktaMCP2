...
async def get_logs(
    ...
    Parameters:
        ...
        filter_expr (str, optional): Filter expression for log events.
    ...
    try:
        ...
        query_params = build_query_params(after=after, limit=limit, since=since, until=until, filter=filter_expr, q=q)
